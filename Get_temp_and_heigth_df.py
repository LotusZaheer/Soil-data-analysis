...
def get_weather(lat, lon):
    url = f"https://api.open-meteo.com/v1/forecast?latitude={lat}&longitude={lon}&daily=temperature_2m_max,temperature_2m_min,precipitation_sum,relative_humidity_2m_max,solar_radiation_sum&timezone=America/Bogota"
    response = requests.get(url)
    if response.status_code == 200:
        ...
        return {
            ...
            'solar_radiation': daily['solar_radiation_sum'][0]
        }
    else:
        return None
...
# Función para obtener altitudes y datos meteorológicos para los municipios
    ...
    for municipio in tqdm(municipios, desc="Procesando municipios", unit="municipio"):
        ...
        try:
            ...
            if weather:
                ...
                precipitación = weather['precipitation']
                humedad_max = weather['humidity_max']
                radiación_solar = weather['solar_radiation']
            else:
                temperatura_max = None
                temperatura_min = None
                precipitación = None
                humedad_max = None
                radiación_solar = None
            ...
            data.append({
                ...
                'Radiacion_Solar': radiación_solar,
            })
...
df_data.to_csv('temp_and_heigth_df.csv', index=False, decimal=',', sep=';')
